% "{'classe':('PSI'),'chapitre':'stat_frot','type':('application'),'titre':'Système EOS', 'source':'Banque PT -- SIA 2016.','comp':('STAT-xx'),'corrige':True}"
...
\addcontentsline{toc}{section}{Application \arabic{cptApplication} : Arc-bouttement -- Système EOS\ifnormal $\star$ \else \fi \ifdifficile $\star\star$ \else \fi \iftdifficile $\star\star\star$ \else \fi -- \ifprof Corrigé \else Sujet \fi}
