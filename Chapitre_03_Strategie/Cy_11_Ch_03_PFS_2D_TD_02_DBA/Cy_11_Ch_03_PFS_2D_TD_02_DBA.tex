% "{'classe':('PSI'),'chapitre':'stat_pfs_2d','type':('td'),'titre':'Dépose de bagage automatique dans les aéroports', 'source':'Concours Centrale Supelec TSI 2013','comp':('B2-14','C1-05','C2-07'),'corrige':True}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_11_Ch_03_PFS_2D_TD_02_DBA_qr}
\end{marginfigure}
\fi
