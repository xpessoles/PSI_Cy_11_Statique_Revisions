%"{'classe':('PSI'),'chapitre':'stat_pfs_2d','type':('td'),'titre':'Stabilisateur vertical pour appareil photo', 'source':'Concours Centrale Supélec 2021 -- PSI','comp':('B2-14','C1-05','C2-07'),'corrige':True}"
...
\marginnote{Concours Centrale Supélec 2021 -- PSI.}
\marginnote{
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_11_Ch_03_PFS_2D_TD_05_StabilisateurVertical_qr}
\end{marginfigure}
\fi
