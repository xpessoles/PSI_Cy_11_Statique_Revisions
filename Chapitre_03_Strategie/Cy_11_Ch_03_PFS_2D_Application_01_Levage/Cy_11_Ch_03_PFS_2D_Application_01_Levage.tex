...
\question{Tracer le graphe des liaisons et justifier que le système est statiquement plan.}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_11_Ch_03_PFS_2D_Application_01_Levage_qr}
\end{marginfigure}
\fi
