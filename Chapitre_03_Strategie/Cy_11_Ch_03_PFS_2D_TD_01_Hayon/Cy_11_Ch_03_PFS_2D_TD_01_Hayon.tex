% "{'classe':('PSI'),'chapitre':'stat_pfs_2d','type':('td'),'titre':'Modélisation d\\'un hayon de coffre électrique', 'source':'Concours Centrale Supélec TSI 2013','comp':('B2-14','C1-05','C2-07'),'corrige':True}"
...
\marginnote{Concours Centrale Supélec TSI 2013.}
\marginnote{
...
\begin{marginfigure}
\includegraphics[width=\linewidth]{fig_01_bis}
%\includegraphics[width=.8\linewidth]{hayon_parametrage}
%\textit{}
\end{marginfigure}
\fi
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_11_Ch_03_PFS_2D_TD_01_Hayon_qr}
\end{marginfigure}
\fi
